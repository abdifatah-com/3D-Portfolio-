...
const CONTACT_LINKS = [
  {
    name: "Email",
    content: "abdifatahmarketing@gmail.com",
    href: "mailto:abdifatahmarketing@gmail.com",
    icon: <FaEnvelope height={"50px"} />,
  },
  {
    name: "Website",
    href: "https://abdifatah.site/",
    content: "abdifatah.site",
    icon: <FaGlobe height={"50px"} />,
  },
  {
    name: "LinkedIn",
    href: "https://www.linkedin.com/in/abdifatah/",
    content: "/abdifatah",
    icon: <FaLinkedin height={"50px"} />,
  },
  {
    name: "GitHub",
    href: "https://github.com/abdifatah-com",
    content: "/abdifatah-com",
          ...
          >
            <div className="flex flex-row lg:flex-col items-center">
              ...
              <div className="flex flex-col gap-3 lg:items-center ml-10 md:ml-20 lg:ml-0">
                <p className="text-center text-xl">Abdifatah</p>
        ...
        <main className="basis-3/4 w-[500px]">
          ...
          >
            ...
            <p className="mb-10 text-roboto">
              Hey there! I&apos;m Abdifatah, a Frontend Developer with hands-on experience in modern web development, 
              creating interactive and responsive user interfaces. I specialize in building beautiful and functional web applications 
              using React, Next.js, and modern JavaScript frameworks. Strong problem-solving skills, effective communication,
              and a passion for creating engaging user experiences.
            </p>
            <p className="mb-10">
